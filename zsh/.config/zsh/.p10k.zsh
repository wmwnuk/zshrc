# Generated by Powerlevel10k configuration wizard on 2022-10-10 at 17:55 CEST.
...
() {
  ...
  # Status background
  typeset -g POWERLEVEL9K_STATUS_{OK,ERROR,OK_PIPE,ERROR_SIGNAL}_BACKGROUND=8
  ...
  ######################[ nnn: nnn shell (https://github.com/jarun/nnn) ]#######################
  # Nnn shell color.
  typeset -g POWERLEVEL9K_NNN_FOREGROUND=2
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_BACKGROUND=12
  ...
  typeset -g POWERLEVEL9K_VI_MODE_INSERT_BACKGROUND=10
  ...
  ##############[ taskwarrior: taskwarrior task count (https://taskwarrior.org/) ]##############
  # Taskwarrior color.
  typeset -g POWERLEVEL9K_TASKWARRIOR_FOREGROUND=12
